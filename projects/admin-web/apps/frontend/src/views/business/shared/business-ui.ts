...
const statusLabels: Record<string, string> = {
  ...
  PLATFORM_CONFIRM_PENDING: '待平台确认',
  ...
  ALL_GROUPS: '全部群组',
  AUTOMATIC: '自动处理',
  C2C_ORDER_CANCELLATION: 'C2C 订单作废',
  PAYMENT_BATCH_COORDINATOR: '支付批次处理',
  PAYMENT_BATCH_SERVICE: '支付批次服务',
  PAYMENT_COORDINATOR: '支付处理协调',
  PAYMENT_ORDER_SERVICE: '支付订单服务',
  PLATFORM_PAYMENT_CONFIRMATION: '平台付款确认',
  PLATFORM_SYNC: '平台订单同步',
  MANUAL: '手动处理',
  TELEGRAM_C2C_REVIEW: 'Telegram 商家订单审核',
