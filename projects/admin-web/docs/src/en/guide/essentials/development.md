...
```json
{
  "scripts": {
    ...
    // Build the frontend application separately
    "build:antd": "pnpm run build --filter=@vben/frontend",
    ...
    "dev:antd": "pnpm -F @vben/frontend run dev",
...
Take the addition of the test environment `test` to `@vben/frontend` as an example:
...
"scripts": {
    ...
    "build:analyze": "turbo build:analyze",
    "build:antd": "pnpm run build --filter=@vben/frontend",
    "build-test:antd": "pnpm run build --filter=@vben/frontend build:test",
...
"tasks": {
    ...
    "build-test:antd": {
      "dependsOn": ["@vben/frontend#build:test"],
      "outputs": ["dist/**"]
    },

    "@vben/frontend#build:test": {
      "dependsOn": ["^build"],
      "outputs": ["dist/**"]
    },
