/**
 * ESLint 规则配置
 * 基于 Alloy Team 的 eslint-config-alloy 规则，适配 NestJS 项目
 *
 * 使用方式：
...
/**
 * 基于 Alloy 的 TypeScript 规则配置
 * 参考: https://github.com/AlloyTeam/eslint-config-alloy
 */
export const alloyTypeScriptRules = {
  ...
  '@typescript-eslint/consistent-type-definitions': {
    ...
    goodExample:
      '<span class="token keyword">interface</span> <span class="token class-name">Foo2</span> <span class="token punctuation">{</span>\n  foo<span class="token punctuation">:</span> <span class="token builtin">string</span><span class="token punctuation">;</span>\n<span class="token punctuation">}</span>',
    fixable: true,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  '@typescript-eslint/consistent-type-imports': {
    ...
    reason: '',
    badExample:
      '<mark class="eslint-error" data-tip="All imports in the declaration are only used as types. Use `import type`.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(@typescript-eslint/consistent-type-imports)&lt;/span&gt;"><span class="token keyword">import</span> <span class="token punctuation">{</span> Foo <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">\'./FooType\'</span><span class="token punctuation">;</span></mark>\n<span class="token keyword">const</span> x<span class="token punctuation">:</span> Foo <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span>',
    goodExample:
      '<span class="token keyword">import</span> <span class="token keyword">type</span> <span class="token punctuation">{</span> Foo <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">\'./FooType\'</span><span class="token punctuation">;</span>\n<span class="token keyword">const</span> x<span class="token punctuation">:</span> Foo <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span>',
    fixable: true,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  '@typescript-eslint/no-import-type-side-effects': {
    ...
    reason: '',
    badExample:
      '<mark class="eslint-error" data-tip="TypeScript will only remove the inline type specifiers which will leave behind a side effect import at runtime. Convert this to a top-level type qualifier to properly remove the entire import.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(@typescript-eslint/no-import-type-side-effects)&lt;/span&gt;"><span class="token keyword">import</span> <span class="token punctuation">{</span> <span class="token keyword">type</span> ArrowFunction <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">\'typescript\'</span><span class="token punctuation">;</span></mark>',
    goodExample:
      '<span class="token keyword">import</span> <span class="token keyword">type</span> <span class="token punctuation">{</span> ArrowFunction <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">\'typescript\'</span><span class="token punctuation">;</span>',
    fixable: true,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  '@typescript-eslint/no-invalid-void-type': {
    ...
    badExample:
      '<span class="token keyword">type</span> Foo1 <span class="token operator">=</span> <span class="token keyword"><mark class="eslint-error" data-tip="void is only valid as a return type or generic type argument.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(@typescript-eslint/no-invalid-void-type)&lt;/span&gt;">void</mark></span><span class="token punctuation">;</span>',
    goodExample:
      '<span class="token keyword">type</span> <span class="token function-variable function">Foo2</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token keyword">void</span><span class="token punctuation">;</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  '@typescript-eslint/no-loss-of-precision': {
    ...
    goodExample:
      '<span class="token keyword">const</span> foo2 <span class="token operator">=</span> <span class="token number">12345</span><span class="token punctuation">;</span>',
    fixable: false,
  ...
  '@typescript-eslint/no-namespace': {
    ...
    badExample:
      '<mark class="eslint-error" data-tip="ES2015 module syntax is preferred over namespaces.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(@typescript-eslint/no-namespace)&lt;/span&gt;"><span class="token keyword">namespace</span> foo1 <span class="token punctuation">{</span><span class="token punctuation">}</span></mark>',
    goodExample:
      '<span class="token keyword">declare</span> <span class="token keyword">namespace</span> foo1 <span class="token punctuation">{</span><span class="token punctuation">}</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  '@typescript-eslint/no-non-null-asserted-optional-chain': {
    ...
    badExample:
      '<span class="token keyword">let</span> foo1<span class="token punctuation">:</span> <span class="token punctuation">{</span> bar<span class="token punctuation">:</span> <span class="token punctuation">{</span> baz<span class="token punctuation">:</span> <span class="token builtin">string</span> <span class="token punctuation">}</span> <span class="token punctuation">}</span> <span class="token operator">|</span> undefined<span class="token punctuation">;</span>\n\n<span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><mark class="eslint-error" data-tip="Optional chain expressions can return undefined by design - using a non-null assertion is unsafe and wrong.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(@typescript-eslint/no-non-null-asserted-optional-chain)&lt;/span&gt;">foo1<span class="token operator">?</span><span class="token punctuation">.</span>bar<span class="token operator">!</span></mark><span class="token punctuation">)</span><span class="token punctuation">;</span>',
    goodExample:
      '<span class="token keyword">let</span> foo2<span class="token punctuation">:</span> <span class="token punctuation">{</span> bar<span class="token punctuation">:</span> <span class="token punctuation">{</span> baz<span class="token punctuation">:</span> <span class="token builtin">string</span> <span class="token punctuation">}</span> <span class="token punctuation">}</span> <span class="token operator">|</span> undefined<span class="token punctuation">;</span>\n\n<span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>foo2<span class="token operator">?</span><span class="token punctuation">.</span>bar<span class="token punctuation">)</span><span class="token punctuation">;</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  '@typescript-eslint/no-unused-vars': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">let</span> foo <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span>\n<mark class="eslint-error" data-tip="&amp;apos;foo&amp;apos; is assigned a value but never used.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(@typescript-eslint/no-unused-vars)&lt;/span&gt;">foo</mark> <span class="token operator">=</span> <span class="token number">2</span><span class="token punctuation">;</span>\n\n<span class="token keyword">function</span> <span class="token function"><mark class="eslint-error" data-tip="&amp;apos;bar&amp;apos; is defined but never used.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(@typescript-eslint/no-unused-vars)&lt;/span&gt;">bar</mark></span><span class="token punctuation">(</span><span class="token parameter"><mark class="eslint-error" data-tip="&amp;apos;baz&amp;apos; is defined but never used.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(@typescript-eslint/no-unused-vars)&lt;/span&gt;">baz</mark></span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>\n\n<span class="token keyword">const</span> <span class="token punctuation">{</span> <mark class="eslint-error" data-tip="&amp;apos;baz&amp;apos; is assigned a value but never used.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(@typescript-eslint/no-unused-vars)&lt;/span&gt;">baz</mark><span class="token punctuation">,</span> <span class="token operator">...</span><mark class="eslint-error" data-tip="&amp;apos;rest&amp;apos; is assigned a value but never used.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(@typescript-eslint/no-unused-vars)&lt;/span&gt;">rest</mark> <span class="token punctuation">}</span> <span class="token operator">=</span> data<span class="token punctuation">;</span>',
    goodExample:
      '<span class="token keyword">let</span> foo <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span>\n<span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>foo<span class="token punctuation">)</span><span class="token punctuation">;</span>\n\n<span class="token keyword">function</span> <span class="token function">bar</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>\n<span class="token function">bar</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>\n\n<span class="token keyword">const</span> <span class="token punctuation">{</span> baz<span class="token punctuation">,</span> <span class="token operator">...</span>rest <span class="token punctuation">}</span> <span class="token operator">=</span> data<span class="token punctuation">;</span>\n<span class="token builtin">console</span><span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>baz<span class="token punctuation">,</span> rest<span class="token punctuation">)</span><span class="token punctuation">;</span>\n\n<span class="token keyword">try</span> <span class="token punctuation">{</span>\n<span class="token punctuation">}</span> <span class="token keyword">catch</span> <span class="token punctuation">(</span>e<span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>',
    fixable: false,
  ...
  '@typescript-eslint/prefer-function-type': {
    ...
    goodExample:
      '<span class="token keyword">type</span> <span class="token function-variable function">Foo2</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token builtin">string</span><span class="token punctuation">;</span>',
    fixable: true,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  '@typescript-eslint/prefer-namespace-keyword': {
    ...
    goodExample:
      '<span class="token keyword">namespace</span> Foo2 <span class="token punctuation">{</span><span class="token punctuation">}</span>',
    fixable: true,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
...
export const alloyBaseRules = {
  ...
  'for-direction': {
    ...
    reason: '',
    badExample:
      '<mark class="eslint-error" data-tip="The update clause in this loop moves the variable in the wrong direction.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(for-direction)&lt;/span&gt;"><span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">let</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> <span class="token number">10</span><span class="token punctuation">;</span> i<span class="token operator">--</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n  <span class="token comment">// do something</span>\n<span class="token punctuation">}</span></mark>',
    goodExample:
      '<span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">let</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> <span class="token number">10</span><span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n  <span class="token comment">// do something</span>\n<span class="token punctuation">}</span>',
    fixable: false,
    extendsBaseRule: '',
  ...
  'func-name-matching': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">const</span> <mark class="eslint-error" data-tip="Function name `bar` should match variable name `foo`.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(func-name-matching)&lt;/span&gt;"><span class="token function-variable function">foo</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token function">bar</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span></mark><span class="token punctuation">;</span>',
    goodExample:
  ...
  'max-params': {
    ...
    reason: '',
    badExample:
      '<mark class="eslint-error" data-tip="Function &amp;apos;foo&amp;apos; has too many parameters (4). Maximum allowed is 3.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(max-params)&lt;/span&gt;"><span class="token keyword">function</span> <span class="token function">foo</span></mark><span class="token punctuation">(</span><span class="token parameter">a1<span class="token punctuation">,</span> a2<span class="token punctuation">,</span> a3<span class="token punctuation">,</span> a4</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>',
    goodExample:
      '<span class="token keyword">function</span> <span class="token function">foo</span><span class="token punctuation">(</span><span class="token parameter">a1<span class="token punctuation">,</span> a2<span class="token punctuation">,</span> a3</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>\n<span class="token keyword">function</span> <span class="token function">bar</span><span class="token punctuation">(</span><span class="token parameter"><span class="token punctuation">{</span> a1<span class="token punctuation">,</span> a2<span class="token punctuation">,</span> a3<span class="token punctuation">,</span> a4 <span class="token punctuation">}</span></span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  'no-compare-neg-zero': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">if</span> <span class="token punctuation">(</span><mark class="eslint-error" data-tip="Do not use the &amp;apos;===&amp;apos; operator to compare against -0.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-compare-neg-zero)&lt;/span&gt;">foo <span class="token operator">===</span> <span class="token operator">-</span><span class="token number">0</span></mark><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n<span class="token punctuation">}</span>',
    goodExample:
  ...
  'no-cond-assign': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">if</span> <span class="token punctuation">(</span><mark class="eslint-error" data-tip="Expected a conditional expression and instead saw an assignment.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-cond-assign)&lt;/span&gt;">foo <span class="token operator">=</span> <span class="token number">0</span></mark><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n<span class="token punctuation">}</span>',
    goodExample:
  ...
  'no-constant-binary-expression': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">const</span> value1 <span class="token operator">=</span> <mark class="eslint-error" data-tip="Unexpected constant binary expression. Compares constantly with the right-hand side of the `==`.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-constant-binary-expression)&lt;/span&gt;"><span class="token operator">+</span>x</mark> <span class="token operator">==</span> <span class="token keyword">null</span><span class="token punctuation">;</span>\n\n<span class="token keyword">const</span> value2 <span class="token operator">=</span> condition <span class="token operator">?</span> x <span class="token punctuation">:</span> <mark class="eslint-error" data-tip="Unexpected constant truthiness on the left-hand side of a `||` expression.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-constant-binary-expression)&lt;/span&gt;"><span class="token punctuation">{</span><span class="token punctuation">}</span></mark> <span class="token operator">||</span> <span class="token constant">DEFAULT</span><span class="token punctuation">;</span>\n\n<span class="token keyword">const</span> value3 <span class="token operator">=</span> <mark class="eslint-error" data-tip="Unexpected constant binary expression. Compares constantly with the right-hand side of the `==`.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-constant-binary-expression)&lt;/span&gt;"><span class="token operator">!</span>foo</mark> <span class="token operator">==</span> <span class="token keyword">null</span><span class="token punctuation">;</span>\n\n<span class="token keyword">const</span> value4 <span class="token operator">=</span> <mark class="eslint-error" data-tip="Unexpected constant binary expression. Compares constantly with the right-hand side of the `===`.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-constant-binary-expression)&lt;/span&gt;"><span class="token keyword">new</span> <span class="token class-name">Boolean</span><span class="token punctuation">(</span>foo<span class="token punctuation">)</span></mark> <span class="token operator">===</span> <span class="token boolean">true</span><span class="token punctuation">;</span>\n\n<span class="token keyword">const</span> objIsEmpty <span class="token operator">=</span> someObj <span class="token operator">===</span> <mark class="eslint-error" data-tip="Unexpected comparison to newly constructed object. These two values can never be equal.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-constant-binary-expression)&lt;/span&gt;"><span class="token punctuation">{</span><span class="token punctuation">}</span></mark><span class="token punctuation">;</span>\n\n<span class="token keyword">const</span> arrIsEmpty <span class="token operator">=</span> someArr <span class="token operator">===</span> <mark class="eslint-error" data-tip="Unexpected comparison to newly constructed object. These two values can never be equal.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-constant-binary-expression)&lt;/span&gt;"><span class="token punctuation">[</span><span class="token punctuation">]</span></mark><span class="token punctuation">;</span>',
    goodExample:
      '<span class="token keyword">const</span> value1 <span class="token operator">=</span> x <span class="token operator">==</span> <span class="token keyword">null</span><span class="token punctuation">;</span>\n\n<span class="token keyword">const</span> value2 <span class="token operator">=</span> <span class="token punctuation">(</span>condition <span class="token operator">?</span> x <span class="token punctuation">:</span> <span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">)</span> <span class="token operator">||</span> <span class="token constant">DEFAULT</span><span class="token punctuation">;</span>\n\n<span class="token keyword">const</span> value3 <span class="token operator">=</span> <span class="token operator">!</span><span class="token punctuation">(</span>foo <span class="token operator">==</span> <span class="token keyword">null</span><span class="token punctuation">)</span><span class="token punctuation">;</span>\n\n<span class="token keyword">const</span> value4 <span class="token operator">=</span> <span class="token function">Boolean</span><span class="token punctuation">(</span>foo<span class="token punctuation">)</span> <span class="token operator">===</span> <span class="token boolean">true</span><span class="token punctuation">;</span>\n\n<span class="token keyword">const</span> objIsEmpty <span class="token operator">=</span> Object<span class="token punctuation">.</span><span class="token function">keys</span><span class="token punctuation">(</span>someObj<span class="token punctuation">)</span><span class="token punctuation">.</span>length <span class="token operator">===</span> <span class="token number">0</span><span class="token punctuation">;</span>\n\n<span class="token keyword">const</span> arrIsEmpty <span class="token operator">=</span> someArr<span class="token punctuation">.</span>length <span class="token operator">===</span> <span class="token number">0</span><span class="token punctuation">;</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  'no-empty': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">if</span> <span class="token punctuation">(</span>foo<span class="token punctuation">)</span> <mark class="eslint-error" data-tip="Empty block statement.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-empty)&lt;/span&gt;"><span class="token punctuation">{</span>\n<span class="token punctuation">}</span></mark>',
    goodExample:
      '<span class="token keyword">if</span> <span class="token punctuation">(</span>foo<span class="token punctuation">)</span> <span class="token punctuation">{</span>\n  <span class="token comment">// do something</span>\n<span class="token punctuation">}</span>\n<span class="token keyword">try</span> <span class="token punctuation">{</span>\n  <span class="token comment">// do something</span>\n<span class="token punctuation">}</span> <span class="token keyword">catch</span> <span class="token punctuation">(</span>e<span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>',
    fixable: false,
    extendsBaseRule: '',
  ...
  'no-empty-character-class': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">const</span> reg <span class="token operator">=</span> <span class="token regex"><mark class="eslint-error" data-tip="Empty class.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-empty-character-class)&lt;/span&gt;">/abc[]/</mark></span><span class="token punctuation">;</span>',
    goodExample:
      '<span class="token keyword">const</span> reg <span class="token operator">=</span> <span class="token regex">/abc[a-z]/</span><span class="token punctuation">;</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  'no-empty-pattern': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">const</span> <mark class="eslint-error" data-tip="Unexpected empty object pattern.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-empty-pattern)&lt;/span&gt;"><span class="token punctuation">{</span><span class="token punctuation">}</span></mark> <span class="token operator">=</span> foo<span class="token punctuation">;</span>',
    goodExample:
  ...
  'no-eq-null': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">if</span> <span class="token punctuation">(</span><mark class="eslint-error" data-tip="Use &amp;apos;===&amp;apos; to compare with null.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-eq-null)&lt;/span&gt;">foo <span class="token operator">==</span> <span class="token keyword">null</span></mark><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n<span class="token punctuation">}</span>',
    goodExample:
  ...
  'no-eval': {
    ...
    reason: '',
    badExample:
      '<span class="token function"><mark class="eslint-error" data-tip="eval can be harmful.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-eval)&lt;/span&gt;">eval</mark></span><span class="token punctuation">(</span><span class="token string">\'const foo = 0\'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>',
    goodExample:
      '<span class="token keyword">const</span> foo <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  'no-extra-bind': {
    ...
    reason: '',
    badExample:
      '<span class="token punctuation">(</span><span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n  <span class="token function">foo</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>\n<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function"><mark class="eslint-error" data-tip="The function binding is unnecessary.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-extra-bind)&lt;/span&gt;">bind</mark></span><span class="token punctuation">(</span>bar<span class="token punctuation">)</span><span class="token punctuation">;</span>',
    goodExample:
      '<span class="token punctuation">(</span><span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n  <span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">foo</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>\n<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">bind</span><span class="token punctuation">(</span>bar<span class="token punctuation">)</span><span class="token punctuation">;</span>',
    fixable: true,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  'no-global-assign': {
    ...
    reason: '',
    badExample:
      '<mark class="eslint-error" data-tip="Read-only global &amp;apos;Object&amp;apos; should not be modified.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-global-assign)&lt;/span&gt;">Object</mark> <span class="token operator">=</span> <span class="token keyword">null</span><span class="token punctuation">;</span>',
    goodExample:
  ...
  'no-invalid-regexp': {
    ...
    goodExample:
      '<span class="token keyword">const</span> reg1 <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">RegExp</span><span class="token punctuation">(</span><span class="token string">\'[a-z]\'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>\n<span class="token keyword">const</span> reg2 <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">RegExp</span><span class="token punctuation">(</span><span class="token string">\'.\'</span><span class="token punctuation">,</span> <span class="token string">\'g\'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  'no-irregular-whitespace': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">function</span> <span class="token function">foo</span><span class="token punctuation">(</span><span class="token punctuation">)</span><mark class="eslint-error" data-tip="Irregular whitespace not allowed.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-irregular-whitespace)&lt;/span&gt;">　</mark><span class="token punctuation">{</span>\n<span class="token punctuation">}</span>',
    goodExample:
  ...
  'no-lone-blocks': {
    ...
    reason: '',
    badExample:
      '<mark class="eslint-error" data-tip="Block is redundant.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-lone-blocks)&lt;/span&gt;"><span class="token punctuation">{</span>\n  <span class="token function">foo</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>\n<span class="token punctuation">}</span></mark>',
    goodExample:
      '<span class="token keyword">if</span> <span class="token punctuation">(</span>foo<span class="token punctuation">)</span> <span class="token punctuation">{</span>\n  <span class="token function">bar</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>\n<span class="token punctuation">}</span>',
    fixable: false,
    extendsBaseRule: '',
  ...
  'no-loss-of-precision': {
    ...
    goodExample:
      '<span class="token keyword">const</span> foo <span class="token operator">=</span> <span class="token number">12345</span><span class="token punctuation">;</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  'no-misleading-character-class': {
    ...
    badExample:
      '<span class="token regex"><mark class="eslint-error" data-tip="Unexpected combined character in character class.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-misleading-character-class)&lt;/span&gt;">/^[Á]$/u</mark></span><span class="token punctuation">.</span><span class="token function">test</span><span class="token punctuation">(</span><span class="token string">\'Á\'</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// false</span>',
    goodExample:
      '<span class="token regex">/^[A]$/u</span><span class="token punctuation">.</span><span class="token function">test</span><span class="token punctuation">(</span><span class="token string">\'A\'</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// true</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  'no-multi-str': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">const</span> foo <span class="token operator">=</span>\n  <span class="token string"><mark class="eslint-error" data-tip="Multiline support is limited to browsers supporting ES5 only.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-multi-str)&lt;/span&gt;">\'Line 1\\\nLine 2\'</mark></span><span class="token punctuation">;</span>',
    goodExample:
      '<span class="token keyword">const</span> foo <span class="token operator">=</span> <span class="token template-string"><span class="token string">`Line 1\nLine 2`</span></span><span class="token punctuation">;</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  'no-new': {
    ...
    badExample:
      '<mark class="eslint-error" data-tip="Do not use &amp;apos;new&amp;apos; for side effects.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-new)&lt;/span&gt;"><span class="token keyword">new</span> <span class="token class-name">Foo</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span></mark>',
    goodExample:
  ...
  'no-new-native-nonconstructor': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">const</span> foo <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name"><mark class="eslint-error" data-tip="`Symbol` cannot be called as a constructor.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-new-native-nonconstructor)&lt;/span&gt;">Symbol</mark></span><span class="token punctuation">(</span><span class="token string">\'foo\'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>\n<span class="token keyword">const</span> bar <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">BigInt</span><span class="token punctuation">(</span><span class="token number">9007199254740991</span><span class="token punctuation">)</span><span class="token punctuation">;</span>',
    goodExample:
      '<span class="token keyword">const</span> foo <span class="token operator">=</span> <span class="token function">Symbol</span><span class="token punctuation">(</span><span class="token string">\'foo\'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>\n<span class="token keyword">const</span> bar <span class="token operator">=</span> <span class="token function">BigInt</span><span class="token punctuation">(</span><span class="token number">9007199254740991</span><span class="token punctuation">)</span><span class="token punctuation">;</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  'no-new-object': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">const</span> foo <span class="token operator">=</span> <mark class="eslint-error" data-tip="The object literal notation {} is preferable.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-new-object)&lt;/span&gt;"><span class="token keyword">new</span> <span class="token class-name">Object</span><span class="token punctuation">(</span><span class="token punctuation">)</span></mark><span class="token punctuation">;</span>',
    goodExample:
  ...
  'no-param-reassign': {
    ...
    goodExample:
      '<span class="token keyword">function</span> <span class="token function">foo</span><span class="token punctuation">(</span><span class="token parameter">bar_</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n  bar <span class="token operator">=</span> bar_ <span class="token operator">||</span> <span class="token string">\'\'</span><span class="token punctuation">;</span>\n<span class="token punctuation">}</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  'no-proto': {
    ...
    badExample:
      '<span class="token keyword">const</span> foo <span class="token operator">=</span> <mark class="eslint-error" data-tip="The &amp;apos;__proto__&amp;apos; property is deprecated.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-proto)&lt;/span&gt;">bar<span class="token punctuation">.</span>__proto__</mark><span class="token punctuation">;</span>\n<mark class="eslint-error" data-tip="The &amp;apos;__proto__&amp;apos; property is deprecated.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-proto)&lt;/span&gt;">bar<span class="token punctuation">.</span>__proto__</mark> <span class="token operator">=</span> baz<span class="token punctuation">;</span>',
    goodExample:
      '<span class="token keyword">const</span> foo <span class="token operator">=</span> Object<span class="token punctuation">.</span><span class="token function">getPrototypeOf</span><span class="token punctuation">(</span>bar<span class="token punctuation">)</span><span class="token punctuation">;</span>\nObject<span class="token punctuation">.</span><span class="token function">setPrototypeOf</span><span class="token punctuation">(</span>bar<span class="token punctuation">,</span> baz<span class="token punctuation">)</span><span class="token punctuation">;</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  'no-self-assign': {
    ...
    reason: '',
    badExample:
      'foo <span class="token operator">=</span> <mark class="eslint-error" data-tip="&amp;apos;foo&amp;apos; is assigned to itself.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-self-assign)&lt;/span&gt;">foo</mark><span class="token punctuation">;</span>',
    goodExample:
  ...
  'no-template-curly-in-string': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">const</span> foo <span class="token operator">=</span> <span class="token string"><mark class="eslint-error" data-tip="Unexpected template string expression.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-template-curly-in-string)&lt;/span&gt;">\'Hello ${bar}\'</mark></span><span class="token punctuation">;</span>',
    goodExample:
      '<span class="token keyword">const</span> foo <span class="token operator">=</span> <span class="token string">\'Hello {bar}\'</span><span class="token punctuation">;</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  'no-throw-literal': {
    ...
    reason: '',
    badExample:
      '<mark class="eslint-error" data-tip="Expected an error object to be thrown.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-throw-literal)&lt;/span&gt;"><span class="token keyword">throw</span> <span class="token string">\'foo\'</span><span class="token punctuation">;</span></mark>\n<mark class="eslint-error" data-tip="Expected an error object to be thrown.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-throw-literal)&lt;/span&gt;"><span class="token keyword">throw</span> <span class="token number">1</span><span class="token punctuation">;</span></mark>',
    goodExample:
  ...
  'no-undef': {
    ...
    reason: '',
    badExample:
      '<span class="token function"><mark class="eslint-error" data-tip="&amp;apos;foo&amp;apos; is not defined.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-undef)&lt;/span&gt;">foo</mark></span><span class="token punctuation">(</span><mark class="eslint-error" data-tip="&amp;apos;bar&amp;apos; is not defined.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-undef)&lt;/span&gt;">bar</mark><span class="token punctuation">)</span><span class="token punctuation">;</span>',
    goodExample:
  ...
  'no-undef-init': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">let</span> <mark class="eslint-error" data-tip="It&amp;apos;s not necessary to initialize &amp;apos;foo&amp;apos; to undefined.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-undef-init)&lt;/span&gt;">foo <span class="token operator">=</span> <span class="token keyword">undefined</span></mark><span class="token punctuation">;</span>',
    goodExample:
  ...
  'no-unreachable-loop': {
    ...
    reason: '',
    badExample:
      '<mark class="eslint-error" data-tip="Invalid loop. Its body allows only one iteration.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-unreachable-loop)&lt;/span&gt;"><span class="token keyword">for</span> <span class="token punctuation">(</span>foo <span class="token keyword">of</span> bar<span class="token punctuation">)</span> <span class="token punctuation">{</span>\n  <span class="token keyword">if</span> <span class="token punctuation">(</span>foo<span class="token punctuation">.</span>id <span class="token operator">===</span> id<span class="token punctuation">)</span> <span class="token punctuation">{</span>\n    <span class="token function">doSomething</span><span class="token punctuation">(</span>foo<span class="token punctuation">)</span><span class="token punctuation">;</span>\n  <span class="token punctuation">}</span>\n  <span class="token keyword">break</span><span class="token punctuation">;</span>\n<span class="token punctuation">}</span></mark>',
    goodExample:
      '<span class="token keyword">for</span> <span class="token punctuation">(</span>foo <span class="token keyword">of</span> bar<span class="token punctuation">)</span> <span class="token punctuation">{</span>\n  <span class="token keyword">if</span> <span class="token punctuation">(</span>foo<span class="token punctuation">.</span>id <span class="token operator">===</span> id<span class="token punctuation">)</span> <span class="token punctuation">{</span>\n    <span class="token function">doSomething</span><span class="token punctuation">(</span>foo<span class="token punctuation">)</span><span class="token punctuation">;</span>\n    <span class="token keyword">break</span><span class="token punctuation">;</span>\n  <span class="token punctuation">}</span>\n<span class="token punctuation">}</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  'no-unused-private-class-members': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">class</span> <span class="token class-name">Foo1</span> <span class="token punctuation">{</span>\n  <mark class="eslint-error" data-tip="&amp;apos;#unusedMember&amp;apos; is defined but never used.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-unused-private-class-members)&lt;/span&gt;">#unusedMember</mark> <span class="token operator">=</span> <span class="token number">5</span><span class="token punctuation">;</span>\n<span class="token punctuation">}</span>\n\n<span class="token keyword">class</span> <span class="token class-name">Foo2</span> <span class="token punctuation">{</span>\n  <mark class="eslint-error" data-tip="&amp;apos;#usedOnlyInWrite&amp;apos; is defined but never used.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-unused-private-class-members)&lt;/span&gt;">#usedOnlyInWrite</mark> <span class="token operator">=</span> <span class="token number">5</span><span class="token punctuation">;</span>\n  <span class="token function">method</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n    <span class="token keyword">this</span><span class="token punctuation">.</span>#usedOnlyInWrite <span class="token operator">=</span> <span class="token number">42</span><span class="token punctuation">;</span>\n  <span class="token punctuation">}</span>\n<span class="token punctuation">}</span>\n\n<span class="token keyword">class</span> <span class="token class-name">Foo3</span> <span class="token punctuation">{</span>\n  <mark class="eslint-error" data-tip="&amp;apos;#usedOnlyToUpdateItself&amp;apos; is defined but never used.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-unused-private-class-members)&lt;/span&gt;">#usedOnlyToUpdateItself</mark> <span class="token operator">=</span> <span class="token number">5</span><span class="token punctuation">;</span>\n  <span class="token function">method</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n    <span class="token keyword">this</span><span class="token punctuation">.</span>#usedOnlyToUpdateItself<span class="token operator">++</span><span class="token punctuation">;</span>\n  <span class="token punctuation">}</span>\n<span class="token punctuation">}</span>\n\n<span class="token keyword">class</span> <span class="token class-name">Foo4</span> <span class="token punctuation">{</span>\n  <mark class="eslint-error" data-tip="&amp;apos;#unusedMethod&amp;apos; is defined but never used.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-unused-private-class-members)&lt;/span&gt;">#<span class="token function">unusedMethod</span></mark><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>\n<span class="token punctuation">}</span>\n\n<span class="token keyword">class</span> <span class="token class-name">Foo5</span> <span class="token punctuation">{</span>\n  <span class="token keyword">get</span> #<span class="token function">unusedAccessor</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>\n  <span class="token keyword">set</span> <mark class="eslint-error" data-tip="&amp;apos;#unusedAccessor&amp;apos; is defined but never used.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-unused-private-class-members)&lt;/span&gt;">#<span class="token function">unusedAccessor</span></mark><span class="token punctuation">(</span><span class="token parameter">value</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>\n<span class="token punctuation">}</span>',
    goodExample:
      '<span class="token keyword">class</span> <span class="token class-name">Foo1</span> <span class="token punctuation">{</span>\n  #usedMember <span class="token operator">=</span> <span class="token number">42</span><span class="token punctuation">;</span>\n  <span class="token function">method</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n    <span class="token keyword">return</span> <span class="token keyword">this</span><span class="token punctuation">.</span>#usedMember<span class="token punctuation">;</span>\n  <span class="token punctuation">}</span>\n<span class="token punctuation">}</span>\n\n<span class="token keyword">class</span> <span class="token class-name">Foo2</span> <span class="token punctuation">{</span>\n  #<span class="token function">usedMethod</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n    <span class="token keyword">return</span> <span class="token number">42</span><span class="token punctuation">;</span>\n  <span class="token punctuation">}</span>\n  <span class="token function">anotherMethod</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n    <span class="token keyword">return</span> <span class="token keyword">this</span><span class="token punctuation">.</span>#<span class="token function">usedMethod</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>\n  <span class="token punctuation">}</span>\n<span class="token punctuation">}</span>\n\n<span class="token keyword">class</span> <span class="token class-name">Foo3</span> <span class="token punctuation">{</span>\n  <span class="token keyword">get</span> #<span class="token function">usedAccessor</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>\n  <span class="token keyword">set</span> #<span class="token function">usedAccessor</span><span class="token punctuation">(</span><span class="token parameter">value</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>\n\n  <span class="token function">method</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n    <span class="token keyword">this</span><span class="token punctuation">.</span>#usedAccessor <span class="token operator">=</span> <span class="token number">42</span><span class="token punctuation">;</span>\n  <span class="token punctuation">}</span>\n<span class="token punctuation">}</span>',
    fixable: false,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  'no-useless-catch': {
    ...
    badExample:
      '<mark class="eslint-error" data-tip="Unnecessary try/catch wrapper.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-useless-catch)&lt;/span&gt;"><span class="token keyword">try</span> <span class="token punctuation">{</span>\n  <span class="token function">doSomethingThatMightThrow</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>\n<span class="token punctuation">}</span> <span class="token keyword">catch</span> <span class="token punctuation">(</span>e<span class="token punctuation">)</span> <span class="token punctuation">{</span>\n  <span class="token keyword">throw</span> e<span class="token punctuation">;</span>\n<span class="token punctuation">}</span></mark>',
    goodExample:
  ...
  'no-var': {
    ...
    reason: '',
    badExample:
      '<mark class="eslint-error" data-tip="Unexpected var, use let or const instead.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(no-var)&lt;/span&gt;"><span class="token keyword">var</span> foo <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span></mark>',
    goodExample:
  ...
  'prefer-arrow-callback': {
    ...
    reason: '',
    badExample:
      '<span class="token function">foo</span><span class="token punctuation">(</span><mark class="eslint-error" data-tip="Unexpected function expression.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(prefer-arrow-callback)&lt;/span&gt;"><span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">a</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n  <span class="token keyword">return</span> a<span class="token punctuation">;</span>\n<span class="token punctuation">}</span></mark><span class="token punctuation">)</span><span class="token punctuation">;</span>',
    goodExample:
      '<span class="token function">oo</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">a</span><span class="token punctuation">)</span> <span class="token operator">=></span> a<span class="token punctuation">)</span><span class="token punctuation">;</span>',
    fixable: true,
    extendsBaseRule: '',
    requiresTypeChecking: false,
  },
  ...
  'use-isnan': {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">if</span> <span class="token punctuation">(</span><mark class="eslint-error" data-tip="Use the isNaN function to compare with NaN.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(use-isnan)&lt;/span&gt;">foo <span class="token operator">===</span> <span class="token number">NaN</span></mark><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n<span class="token punctuation">}</span>',
    goodExample:
      '<span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token function">isNaN</span><span class="token punctuation">(</span>foo<span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n<span class="token punctuation">}</span>',
    fixable: false,
    extendsBaseRule: '',
  ...
  yoda: {
    ...
    reason: '',
    badExample:
      '<span class="token keyword">if</span> <span class="token punctuation">(</span><mark class="eslint-error" data-tip="Expected literal to be on the right side of ===.&lt;br/&gt;&lt;span class=\'eslint-error-rule-id\'&gt;eslint(yoda)&lt;/span&gt;"><span class="token number">1</span> <span class="token operator">===</span> foo</mark><span class="token punctuation">)</span> <span class="token punctuation">{</span>\n<span class="token punctuation">}</span>',
    goodExample:
...
/**
 * 合并所有规则
 * 将元数据对象转换为实际的 ESLint 规则配置
 */
export const alloyRules = {
  rules: Object.fromEntries(
    Object.entries({
      ...alloyBaseRules,
      ...alloyTypeScriptRules,
